...
Always read `../status/person_b_jeevan.md` and `../status/person_a_ameen.md` before starting work, and update the relevant one (with IST date and time) after finishing.
